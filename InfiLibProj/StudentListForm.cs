...
namespace InfiLibProj
{
    public partial class StudentListForm : Form
    {
        ...
        private void SearchBtnStList_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand searchByFName = new MySqlCommand("SELECT * FROM `students` WHERE f_name LIKE '%" + SearchLineStList.Text + "%';", db.getConnection());
            searchByFName.Parameters.Add("@studentFName", MySqlDbType.VarChar).Value = SearchLineStList.Text;

            MySqlCommand searchByLName = new MySqlCommand("SELECT * FROM `students` WHERE l_name LIKE '%" + SearchLineStList.Text + "%';", db.getConnection());
            searchByLName.Parameters.Add("@studentLName", MySqlDbType.VarChar).Value = SearchLineStList.Text;

            MySqlCommand searchByEmail = new MySqlCommand("SELECT * FROM `students` WHERE email LIKE '%" + SearchLineStList.Text + "%';", db.getConnection());
