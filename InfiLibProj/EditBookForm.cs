...
namespace InfiLibProj
{
    public partial class EditBookForm : Form
    {
        ...
        private void EditBookBtn_Click(object sender, EventArgs e)
        {
            ...
            NameEdit.Parameters.Add("@id", MySqlDbType.Int16).Value = BookIDEdit.Text;
            AuthorEdit.Parameters.Add("@id", MySqlDbType.Int16).Value = BookIDEdit.Text;
            GenreEdit.Parameters.Add("@id", MySqlDbType.Int16).Value = BookIDEdit.Text;
            DescriptionEdit.Parameters.Add("@id", MySqlDbType.Int16).Value = BookIDEdit.Text;
            IssuedEdit.Parameters.Add("@id", MySqlDbType.Int16).Value = BookIDEdit.Text;
            ImageEdit.Parameters.Add("@id", MySqlDbType.Int16).Value = BookIDEdit.Text;
            ...
            IssuedEdit.Parameters.Add("@issued", MySqlDbType.Int16).Value = Convert.ToInt64(BookIssueEdit.Checked);
