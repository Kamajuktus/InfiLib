...
namespace InfiLibProj
{
    public partial class BookListForm : Form
    {
        ...
        private void SearchBtnBookList_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand searchByName = new MySqlCommand("SELECT * FROM `books` WHERE name LIKE '%" + SearchLineBookList.Text + "%';", db.getConnection());

            MySqlCommand searchByAuthor = new MySqlCommand("SELECT * FROM `books` WHERE author LIKE '%" + SearchLineBookList.Text + "%';", db.getConnection());

            MySqlCommand searchByGenre = new MySqlCommand("SELECT * FROM `books` WHERE genre LIKE '%" + SearchLineBookList.Text + "%';", db.getConnection());

            MySqlCommand searchByIssue = new MySqlCommand("SELECT * FROM `books` WHERE issued LIKE '%" + SearchLineBookList.Text + "%';", db.getConnection());
